...
static const unsigned long MAX_UPTIME_BEFORE_RESTART = 604800000UL; // 7 gün = 604800000ms
...
void performHealthCheck() {
  ...
  // mDNS periyodik yenileme (1 saatte bir)
  ...
  // Uptime kontrolü - 7 günde bir otomatik restart (bellek fragmentasyonu önleme)
  systemUptime = millis();
  if (systemUptime > MAX_UPTIME_BEFORE_RESTART) {
    DEBUG_PRINTLN("==========================================");
    DEBUG_PRINTLN("[HEALTH] 7 gunluk uptime - Planli restart");
